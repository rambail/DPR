...
class MetroReportGenerator:
    def __init__(self, corridor, parameters, train_composition, capacity, years,
        ...
        self.output_dir = os.path.join(os.getcwd(), 'report')
        os.makedirs(self.output_dir, exist_ok=True)
        self.doc_path = os.path.join(self.output_dir, "Metro_Capacity_Report.docx")
